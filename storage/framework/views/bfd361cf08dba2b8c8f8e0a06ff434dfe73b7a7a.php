...
<body>
<form action="<?php echo e(route('admin.post.create')); ?>" method="POST">
  <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group col-md-8">
          ...
          <div class="controls">
              ...
              -webkit-box-shadow: 0 1px 3px rgba(34, 25, 25, 0.4);" class="img-bnupload" src="<?php echo e(asset('uploads/imguser/auduino.png')); ?>" width="50px" height="50px">
          </div>
        </div>
        <div class="form-group col-md-8">
...
<?php /**PATH E:\xampp\htdocs\blog\resources\views/admin/create.blade.php ENDPATH**/ ?>