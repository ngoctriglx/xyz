...
<head>
    <meta charset="UTF-8">
    <link href="{{ asset('css/home/resetpassword.css')}}" rel="stylesheet" type="text/css">
        ...
        <div class="row wrap-change">
            <div class="col-xs-12 col-sm-12 col-md-6" style="width: 100%;">
                <div class="panel panel-info">
                    <form action="{{route('user.post.newpass')}}" method="POST">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="input-group pass_show">
                                            ...
                                            @if ($errors->has('repassword'))
                                                <small class="alert alert-danger">{{ $errors->first('repassword') }}</small>
                                            @endif
                                        </div>
                                    </div>
                                </div>
